...
describe("Scope", function(){
    ...
    describe("digest", function(){
        ...
        it("eventually halts $evalAsync added by wathches", function(){
            scope.aValue = [1, 2, 3];
        ...
        it("colesces many calls to $applyAsync", function(done){
            scope.counter = 0;
        ...
        it("cancel and flush $applyAsync if digested first", function(done){
            scope.counter = 0;
        ...
        it("catches exceptions in $applyAsync", function(done) { scope.$applyAsync(function(scope) {
            throw "Error"; });
            scope.$applyAsync(function(scope) { 
                throw "Error";
            }); 
        ...
        it("allows destorying a $watch with", function(){
            scope.aValue = 'abc';
            scope.counter = 0;
    ...
    describe('$watchGroup', function(){
        ...
        it('use the different arrays for old and new values on subsequent runs', function(){
            var gotNewValues, gotOldValues;
        ...
        it("doest not call the zero-watch listener when dereistered first", function(){
            var counter = 0;
    ...
    describe('iheritance', function(){
        ...
        it("does not cause a parent to inhert its properties", function(){
            var parent = new Scope();
        ...
        it("inherits the parent properties whenever they are defined", function(){
            var parent = new Scope();
            var child = parent.$new();
        ...
        it('can manipulate a parent scope property', function(){
            var parent  = new Scope();
            var child = parent.$new();
        ...
        it('can be nested at any deptn', function(){
            var a = new Scope();
            var aa = a.$new();
            var aaa = aa.$new();
    ...
    describe("$watchCollection", function(){
        ...
        it("works like a normal watch for non-collections", function(){
            ...
            scope.$digest();
            expect(scope.counter).toBe(1);
            expect(valueProvied).toBe(scope.aValue);
        ...
        it("noctices when an attributes is changed in an object", function(){
            scope.counter = 0;
            scope.obj = {a:1};
        ...
        it("gives the old non-collection value to listneners", function(){
            scope.aValue = 42;
    ...
    describe("Events", function(){
        ...
        it("calls the listeners of the mathcing event on $emit", function(){
        ...
        it("propagates down the same event down on $broadcast", function(){
            var scopeListener = jasmine.createSpy();
            var childListener = jasmine.createSpy();
